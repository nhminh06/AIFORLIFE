        ...
        {lessons.map((l) => {
          ...
          return (
            <a
              key={l.title}
              href="#"
              className="group flex flex-col rounded-2xl border border-slate-200 bg-white p-4 shadow-sm shadow-slate-200/50 transition-all hover:-translate-y-0.5 hover:shadow-md"
            >
              ...
              <div className="mt-4">
                <div className="mb-1.5 flex items-center justify-between text-xs font-medium">
                  ...
                  <span className="text-slate-700">{l.progress}%</span>
                </div>
